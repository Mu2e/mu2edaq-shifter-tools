...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='List files in a directory and save to JSON.')
    parser.add_argument('-l', '--dirlist', nargs='+', help='List of directories to list files and save to JSON')
    parser.add_argument('-d', '--directory', default='.', help='Directory to list files from')
    parser.add_argument('-o', '--output_file', default='ls-output.json', help='Output JSON file path')
        ...
        with open(output_file, 'r') as json_file:
            ...
            for directory in data:
                ...
                for file in directory['files']:    
                    print(f"File: {file['name']}, Size: {file['size']} bytes, Modified Time: {file['modified_time']}")
